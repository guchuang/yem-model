...
public class AddYemSubscribeRequest extends BaseMsgRequest<AddYemSubscribeResponse>{
	...
	@BizData(isNotNull=false, fixLength=14, description="预约编码")
	...
	@Override
	public Class<AddYemSubscribeResponse> responseMsgBodyClass() {
		return AddYemSubscribeResponse.class;
	}
}